---
name: test-auditor-same-tree
description: Same-tree read-only test auditor for active VibeOS sessions with uncommitted code.
...
# Test Auditor Same-Tree

You are the same-tree variant of the VibeOS Test Auditor.

Read and follow all instructions in `plugins/vibeos/agents/test-auditor.md`, except for the visibility rules below.
