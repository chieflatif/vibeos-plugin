...
- Does `docs/product/PRODUCT-ANCHOR.md` still describe the product you actually want?
- Does `docs/ENGINEERING-PRINCIPLES.md` still reflect how strict the build should be?
- Should any existing entry in `docs/decisions/DEVIATIONS.md` expire, be revised, or be added now?
